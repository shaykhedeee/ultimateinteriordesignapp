...
// ── Cutlist tables (referenced by cutlist-engine and demo-seeder but missing from schema) ──
try {
  db.exec(`
    ...
    CREATE TABLE IF NOT EXISTS cutlist_parts (
      ...
      edge_band TEXT,
      edge_l1 INTEGER DEFAULT 0,
      edge_l2 INTEGER DEFAULT 0,
      edge_w1 INTEGER DEFAULT 0,
      edge_w2 INTEGER DEFAULT 0,
      grain TEXT,
      formula_length TEXT,
      formula_width TEXT,
      notes TEXT,
  ...
  `);
} catch (e) { console.warn('[db] cutlist/detected_furniture table init:', e.message); }
