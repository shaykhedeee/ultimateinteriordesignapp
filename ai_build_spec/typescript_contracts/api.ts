...
import type { BudgetProfile, EstimateSet, Invoice, PaymentPlan, PaymentReceipt, PurchaseOrder, VariationOrder } from './commercial';
...
export interface SceneCompareDto {
  left: { id: UUID; branchName: string; versionNumber: number; isLocked: boolean };
  right: { id: UUID; branchName: string; versionNumber: number; isLocked: boolean };
  summary: {
