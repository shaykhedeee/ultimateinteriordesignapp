import { z } from 'zod';
import { APPROVAL_STATUS, BUDGET_BANDS, DRAWING_TYPES, ESTIMATE_STATUSES, ESTIMATE_TYPES, INVOICE_STATUSES, INVOICE_TYPES, JOB_STATUSES, JOB_TYPES, MODULE_TYPES, PAYMENT_METHODS, PAYMENT_STATUSES, PROJECT_STAGES, PROJECT_STATUSES, RENDER_TIERS, ROOM_TYPES, RULE_SEVERITIES, RULE_STATUSES, USER_ROLES, VARIATION_STATUSES, } from './enums';
