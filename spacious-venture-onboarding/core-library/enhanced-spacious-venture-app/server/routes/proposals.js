...
function addCover(doc, project, studioSettings) {
  ...
  doc.fillColor('#1d211d').font('Helvetica-Bold').fontSize(26).text(studioSettings.brandName, 42, 60);
...
function addSignoff(doc, project, studioSettings) {
  ...
  doc.fillColor('#55594f').font('Helvetica').fontSize(11).text(studioSettings.handoverNote || 'Next steps: site measurement, working drawings, final catalogue/code selection, and cutlist preparation can proceed from this approved brief.', 42, 150, { width: 500, lineGap: 4 });
