...
CREATE INDEX idx_fpa_project ON floor_plan_analyses(project_id);
...
CREATE INDEX idx_rg_project ON render_generations(project_id);
...
CREATE INDEX idx_rv_generation ON render_variants(generation_id);
...
CREATE INDEX idx_ccc_project ON component_color_changes(project_id);
...
CREATE INDEX idx_rl_category ON reference_library(category);
CREATE INDEX idx_rl_style ON reference_library(style);
...
CREATE UNIQUE INDEX idx_ucp_component ON user_color_preferences(studio_id, component_type);
